...
<table style="text-align: left; width: 984px; height: 1026px;" border="1" cellpadding="2" cellspacing="2">
...
<tbody>
<tr>
<td style="vertical-align: top;">北京<br>
<a href="http://www.pm2d5.com/city/chongqing.html" target="_blank"><strong></strong></a></td>
...
<br>
      ...
      <td style="vertical-align: top; width: 545px;"><?php //print $_GET['dt'];
...
echo "<table border='1'>";
print "<tr><td>排名</td><td>城市</td><td>AQI</td><td>时间</td><td>变化</td></tr>";
$no=1;
...
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3F1d8df5c13e8e74a03ecbc530e27df193' type='text/javascript'%3E%3C/script%3E"));
</script>
<span style="color: white;">aqi pm2.5 pm </span> email:webmaster@aqi.yupage.com
<br>
      <br>
      </td>
    </tr>
